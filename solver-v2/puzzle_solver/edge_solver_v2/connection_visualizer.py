...
class ConnectionVisualizer:
    ...
    @staticmethod
    def visualize_connections_dialog(piece_connections, piece_frame_segments, original_image, project_root, temp_folder=None, show_dialog=True):
        ...
        # Display (only if show_dialog is True)
        if show_dialog:
