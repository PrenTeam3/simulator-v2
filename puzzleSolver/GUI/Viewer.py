...
class Viewer(QMainWindow):
    ...
    def open(self):
        ...
        if fileName:
            ...
            self.solveBlackOnlyAct.setEnabled(True)
    ...
    def solve(self):
        ...
        self.solveBlackOnlyAct.setEnabled(False)
    ...
    def solveBlackOnly(self):
        """
        Callback to start resolution for black-only puzzles (max 6 pieces, all border)
        """
        self.solveAct.setEnabled(False)
        self.solveGreenAct.setEnabled(False)
        self.solveBlackOnlyAct.setEnabled(False)
        ...
        self.thread = SolveThread(self.imgs[0], self, black_only=True)
        self.thread.finished.connect(self.endSolve)
        self.thread.start()
    ...
    def createActions(self):
        ...
        self.solveBlackOnlyAct = QAction(
            "&Solve puzzle (Black Only, Max 6)",
            self,
            shortcut="Ctrl+B",
            enabled=False,
            triggered=self.solveBlackOnly,
        )
    ...
    def createMenus(self):
        ...
        self.fileMenu.addAction(self.solveBlackOnlyAct)
